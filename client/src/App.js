...
import PatientManualSymp from "./components/patientDashboard/PatientManualSymp";
import UploadReports from "./components/patientDashboard/UploadReports";
  ...
  return (
    <div className="bg-bgprimary flex">
      <Routes>
        ...
        />
        <Route
          path="manualsym/sendsymptoms/childprocess"
          element={
            <PatientManualSymp
              // setPrescriptionID={setPrescriptionID}
              settoastCondition={settoastCondition}
