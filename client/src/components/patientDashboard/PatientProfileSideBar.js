...
{/* Changes */}
              {/* <Link
                to="/patient/upload"
                onClick={() => setToggle("Patient_presc")}
                className={
                  Toggle === "Patient_presc"
                    ? "text-gray-900"
                    : "text-gray-400"
                }
              >
                <div className="flex p-2">
                  <img
                    ...
                    alt="profile"
                  ></img>
                  <h1 className="ml-6">Upload Reports</h1>
                </div>
              </Link> */}
              <Link
                to="/patient/manualsym"
                onClick={() => setToggle("Patient_manual_presc")}
                className={
                  Toggle === "Patient_manual_presc"
                    ? "text-gray-900"
                    : "text-gray-400"
                }
              >
                <div className="flex p-2">
                  <img
                    ...
                    alt="profile"
                  ></img>
                  <h1 className="ml-4">Prediction</h1>
                </div>
              </Link>
        ...
        <div className=" mx-auto mt-50 py-1    bg-primary  rounded font-semibold font-poppins shadow-sm hover:bg-bgsecondary w-2/5  ">
