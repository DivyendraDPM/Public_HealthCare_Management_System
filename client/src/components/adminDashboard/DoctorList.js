...
const DoctorList = (props) => {
  ...
  return (
    <div className="m-4 mt-4 font-poppins col-span-10">
      ...
      <div id="scroll" style={{ overflowY: "scroll", height: "450px" }} className="grid grid-rows-2m-14 ml-14 mt-8 mr-12 bg-white rounded shadow p-6 gap-4"> 
        <div className="grid grid-cols-9 font-bold pl-6">
          <h1>Sr.No.</h1>
          <h1 className="col-span-2">Doctor Name</h1>
          <h1 className="col-span-1">Address</h1>
          <h1 className="col-span-2">Speciality</h1>
          <h1 className="col-span-2">Consulataion Fee</h1>
          <h1>Action</h1>
        </div>
        <hr></hr>
        {doctorList.length > 0 ? (
