...
const DoctorListCompo = (props) => {
  ...
  return (
    <div className="grid grid-cols-9 pl-6">
      ...
      <h1 className="col-span-1">{props.doctor.address}</h1>
      <h1 className="col-span-2">{props.doctor.specialization}</h1>
      <div className="col-span-2 pr-2">
        <h1 className="">{props.doctor.consultationFee}</h1>
